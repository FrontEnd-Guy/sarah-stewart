...
const BouncingMarker = ({ position }) => {
  return (
    <Marker position={position} icon={new L.DivIcon({
      ...
      <Popup>
        For plaster work, Sarah’s Reef seashells and painted paper cards visit The Studio Gallery in Grayton Beach
      </Popup>
    </Marker>
  );
}
    ...
    <>
      ...
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          ...
          <a href='mailto:sarahstewartfineart@gmail.com' className='p-text'>sarahstewartfineart@gmail.com</a>
        </div>
        <div className='app__footer-card'>
          <img src={images.mobile} alt='mobile' />
          <a href='tel: +1 (850) 525-4800' className='p-text'>(850) 525-4800</a>
        </div>
      </div>
